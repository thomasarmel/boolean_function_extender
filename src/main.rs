...
const GOOD_CLASS: u32 = 0x88ddbb11;

fn main() {
    let walsh_spectrum_eq = U32Tester::absolute_walsh_spectrum(&GOOD_CLASS);
    let autocorrelation_spectrum_eq = U32Tester::absolute_autocorrelation_spectrum(&GOOD_CLASS);
